...
#                move_center_to, attach_to, fill_color
#
...
#        necessary?  Why?
#        when you want the objects to stay on the screen for viewing.
#        It makes the viewer have to manually close the window instead of it closing after the code runs.
#
